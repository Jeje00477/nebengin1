  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      <div className="px-6 py-4 flex items-center border-b border-gray-100">
        ...
        <h1 className="text-xl font-semibold ml-2">Rider &mdash; Masuk atau Daftar</h1>
      </div>
      ...
      <div className="px-6 py-6 flex-1 flex flex-col">
        ...
        {activeTab === 'masuk' ? (
          <form onSubmit={handleLogin} className="space-y-4 flex-1">
            ...
            <div className="pt-6">
              <Button label="Masuk sebagai Rider" type="submit" fullWidth loading={loading} className="bg-green-600 hover:bg-green-700" />
            </div>
            
            <div className="text-center mt-6">
              <button type="button" onClick={() => { setActiveTab('daftar'); setGeneralError(''); setFieldErrors({}); }} className="text-sm text-green-600 font-semibold hover:underline">
          ...
          <form onSubmit={handleRegister} className="space-y-4 flex-1">
            ...
            <Input label="Email" type="email" placeholder="contoh@student.ub.ac.id" value={email} onChange={e => {setEmail(e.target.value); clearError('email');}} error={fieldErrors.email} />
            <Input label="Nomor WhatsApp" type="tel" placeholder="081234567890" value={nomorWa} onChange={e => {setNomorWa(e.target.value); clearError('nomorWa');}} hint="Nomor ini akan digunakan driver untuk menghubungi kamu" error={fieldErrors.nomorWa} />
            ...
            <div className="pt-6 pb-6">
              <Button label="Daftar sebagai Rider" type="submit" fullWidth loading={loading} className="bg-green-600 hover:bg-green-700" />
            </div>
          </form>
        )}
      </div>
